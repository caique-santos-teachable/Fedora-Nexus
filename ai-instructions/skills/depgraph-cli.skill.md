---
name: depgraph-cli
description: "Use when: running depgraph from the command line (no MCP server available). Covers all CLI commands, flags, output parsing, and recommended workflows. Domain: depgraph, CLI."
---
