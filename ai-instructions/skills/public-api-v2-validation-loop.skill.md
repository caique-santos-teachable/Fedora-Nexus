...
description: "Use when: implementing or validating any Public API V2 task. Enforces the implementation-and-validation loop: 100% test coverage, deterministic seed, curl validation, and standardized local Markdown report."
---
