---
applyTo: "**"
description: depgraph dependency analysis — use these tools to understand code before making changes
---
# depgraph MCP — Instructions
...
For specific workflows, use these prompts (available via prompt picker or slash commands):
